...
| cuk_campus_life_notices | 공식 | https://www.catholic.ac.kr/ko/campuslife/notice_outside.do | 중간 | implemented | 외부기관공지 board를 `campus_life_notices` public surface와 `outside_agencies` current snapshot query flow로 정규화 |
