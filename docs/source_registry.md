...
| cuk_pc_software | 공식 | https://www.catholic.ac.kr/ko/campuslife/pc.do | 중간 | implemented | `실습실 이용안내`의 마리아관/중앙도서관 미디어룸 PC사양 표를 파싱해 `pc_software_entries` search helper fixture로 정규화 |
